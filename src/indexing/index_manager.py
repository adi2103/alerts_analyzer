...
class IndexManager:
    ...
    def update_for_new_alert(self, alert_state: AlertState, timestamp: datetime) -> None:
        """
    ...
    def update_for_resolved_alert(self, alert_state: AlertState, timestamp: datetime) -> None:
        """
