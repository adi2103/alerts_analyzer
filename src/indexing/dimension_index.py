...
class Index:
    ...
    def __init__(self, name: str, extractor_func: Callable[[AlertState], Optional[str]]):
        """
        Initialize an Index.
        ...
        self.entity_states: Dict[str, EntityState] = {}  # entity_value → EntityState
        ...
        self.entity_positions: Dict[str, float] = {}  # entity_value → unhealthy_time
    ...
    def update_entity_position(self, entity_value: str, old_time: float, new_time: float) -> None:
        """
