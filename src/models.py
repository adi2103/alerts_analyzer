...
class EntityState:
    ...
    def __init__(self):
        ...
        self.unhealthy_start: Optional[datetime] = None  # Timestamp when entity became unhealthy
        
        # Time series data for temporal analysis
        self.unhealthy_periods: List[Tuple[datetime, datetime]] = []  # List of (start_time, end_time) tuples
    ...
    def calculate_unhealthy_time_in_range(self, start_time: Optional[datetime] = None, 
    ...
    def __repr__(self) -> str:
        ...
        return (f"EntityState(total_unhealthy_time={self.total_unhealthy_time}, "
                f"current_alerts={len(self.current_alerts)}, "
                f"is_unhealthy={self.is_unhealthy()})")
