...
class TestAlertAnalyzer:
    ...
    def test_register_dimension(self, analyzer):
        ...
        analyzer.register_dimension("test", lambda alert_state: alert_state.tags.get("test"))
    ...
    def test_process_event_ack(self, analyzer, sample_alert_event_new, sample_alert_event_ack):
    ...
    def test_process_event_rsv(self, analyzer, sample_alert_event_new, sample_alert_event_rsv):
    ...
    def test_full_alert_lifecycle(self, analyzer, sample_alert_event_new, 
                                 sample_alert_event_ack, sample_alert_event_rsv):
    ...
    def test_multiple_alerts_same_host(self, analyzer):
        ...
        alert2_new = AlertEvent(
            event_id="event-126",
            alert_id="alert-456",
            timestamp=datetime(2023, 1, 1, 12, 5, 0),  # 5 minutes after first alert
            state="NEW",
        ...
        alert1_rsv = AlertEvent(
            event_id="event-125",
            alert_id="alert-123",
            timestamp=datetime(2023, 1, 1, 12, 10, 0),  # 10 minutes after first alert
            state="RSV",
            alert_type="Disk Usage Alert",
            tags={"host": "host-456", "dc": "dc-789", "volume": "vol-123"}
        )
        ...
        alert2_rsv = AlertEvent(
            event_id="event-127",
            alert_id="alert-456",
            timestamp=datetime(2023, 1, 1, 12, 15, 0),  # 15 minutes after first alert
            state="RSV",
            alert_type="System Service Failed",
            tags={"host": "host-456", "dc": "dc-789", "service": "svc-123"}
        )
        ...
        # The host was unhealthy from the first alert (12:00) until the last alert was resolved (12:15)
