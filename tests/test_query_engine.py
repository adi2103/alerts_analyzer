...
class TestQueryEngine:
    ...
    def populated_analyzer(self):
        ...
        # Process all events
        for event in [host1_new, host1_rsv, host2_new, host2_rsv, host3_new, host3_rsv,
                     host4_new, host4_rsv, host5_new, host5_rsv]:
    ...
    def test_get_top_k_with_different_dimensions(self, populated_analyzer):
        ...
        # Note: The order might vary due to ties, but all should have 25 minutes
        for dc in top_dcs:
            assert dc["total_unhealthy_time"] in [1500, 1500, 1500]  # All have 25 minutes = 1500 seconds
