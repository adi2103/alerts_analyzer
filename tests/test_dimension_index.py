...
class TestIndex:
    ...
    def test_get_top_k(self, host_index):
        ...
        host_index.update_entity_position("host-456", 0, 600)
        host_index.get_entity_state("host-456").alert_type_counts["Disk Usage Alert"] = 1
        
        host_index.update_entity_position("host-789", 0, 900)
        host_index.get_entity_state("host-789").alert_type_counts["System Service Failed"] = 2
        
        host_index.update_entity_position("host-123", 0, 300)
        host_index.get_entity_state("host-123").alert_type_counts["Time Drift Alert"] = 1
